 ...
 */
public class QuestionButtonFlexibleScrollable {

    public QuestionButtonFlexibleScrollable(Context context, int sectionNum, int questionNum, final QuestionnaireActivity.QuestionHandler questionHandler){
        ...
        View view = inflater.inflate(R.layout.cell_button_flexible_scrollable, QuestionnaireActivity.containerLayout, true);
